		...
		<div className="min-h-full flex">
			<Transition.Root show={sidebarOpen} as={Fragment}>
				...
				>
					...
					>
						<div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-neutral-800">
							<Transition.Child
								as={Fragment}
										...
										<div className="mt-2 space-y-1">
											{projects.map((project) => (
												<a
													key={project.id}
													href={project.href}
													className="flex items-center text-neutral-300 hover:bg-neutral-700 hover:text-white px-2 py-2 text-base font-medium rounded-md"
												>
			...
			<div className="hidden lg:flex lg:w-64 lg:fixed lg:inset-y-0">
				...
				<div className="flex-1 flex flex-col min-h-0">
					...
					<div className="flex-1 flex flex-col overflow-y-auto bg-neutral-800">
								...
								<div className="mt-2 space-y-1">
									{projects.map((project) => (
										<a
											key={project.id}
											href={project.href}
											className="group flex items-center px-3 py-2 text-sm font-medium text-neutral-300 rounded-md hover:text-white hover:bg-neutral-700"
										>
											<span className="truncate">{project.name}</span>
										</a>
									))}
			...
			<div className="lg:pl-64 flex flex-col w-0 flex-1">
				<div className="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-white border-b border-neutral-200">
					<button
						type="button"
						className="px-4 border-r border-neutral-200 text-neutral-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 lg:hidden"
						...
						<div className="flex-1 flex">
							<form className="w-full flex lg:ml-0" action="#" method="GET">
								...
								<div className="relative w-full text-neutral-400 focus-within:text-neutral-600">
									...
									<input
										id="search-field"
										className="block w-full h-full pl-8 pr-3 py-2 border-transparent text-neutral-900 placeholder-neutral-500 focus:outline-none focus:placeholder-neutral-400 focus:ring-0 focus:border-transparent sm:text-sm"
										placeholder="Search"
										type="search"
										name="search"
									/>
				...
				<main className="flex-1">
					<div className="py-8 xl:py-10">
						<div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 xl:max-w-5xl xl:grid xl:grid-cols-3">
							<div className="xl:col-span-2 xl:pr-8 xl:border-r xl:border-neutral-200">
								<div>
									<div>
										<div className="md:flex md:items-center md:justify-between md:space-x-4 xl:border-b xl:pb-6">
											...
											<div className="mt-4 flex space-x-3 md:mt-0">
												<button
													type="button"
													className="inline-flex justify-center px-4 py-2 border border-neutral-300 shadow-sm text-sm font-medium rounded-md text-neutral-700 bg-white hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
												>
													<PencilIcon
										...
										<aside className="mt-8 xl:hidden">
											...
											<div className="mt-6 border-t border-b border-neutral-200 py-6 space-y-8">
												<div>
																		...
																		{item.type === "comment" ? (
																			<>
																				<div className="relative">
																					<img
																						className="h-10 w-10 rounded-full bg-neutral-400 flex items-center justify-center ring-8 ring-white"
																						src={item.imageUrl}
																						alt=""
																					/>
															...
															<form action="#">
																<div>
																	...
																	<textarea
																		...
																		name="comment"
																		rows={3}
																		className="shadow-sm block w-full focus:ring-blue-500 focus:border-neutral-900 sm:text-sm border border-neutral-300 rounded-md"
							...
							<aside className="hidden xl:block xl:pl-8">
								...
								<div className="mt-6 border-t border-neutral-200 py-6 space-y-8">
									<div>
										<h2 className="text-sm font-medium text-neutral-500">
											Assignees
										</h2>
